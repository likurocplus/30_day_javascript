...
// dIV0SSUTgAdKwStr
// '
function userIdGenerator(input) {
    let id = []
    let i = 0
    while(id.length < input){
...
function userIdGeneratedByUser() {
    let input = prompt(`Hay nhap do dai ID: `)
    let soluong = prompt(`Hay nhap so luong id muon tao: `)
    let i = 0
    let id = []
    for( i = 0 ; i < soluong; i++){
        console.log(userIdGenerator(input))
    }  
}
userIdGeneratedByUser()
